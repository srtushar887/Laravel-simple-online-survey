                ...
                <div class="card-body">
                     <form class="needs-validation" novalidate="" action="{{route('admin.general.settings.update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="validationCustom01">Get Monet Created Post User</label>
                                    <input type="text" class="form-control" name="get_money_created_post_user" value="{{$gen->get_money_created_post_user}}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
