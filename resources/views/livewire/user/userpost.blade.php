<main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
    ...
    @foreach($posts as $post)
        ...
        <?php
            $exist_post_like = \App\Models\post_like::where('user_id',Auth::user()->id)->where('post_id',$post->id)->where('user_type',2)->count();
            $exist_post_comment = \App\Models\post_comment::where('user_id',Auth::user()->id)->where('post_id',$post->id)->where('user_type',2)->count();
        ?>

    @if ($exist_post_like <= 0)
